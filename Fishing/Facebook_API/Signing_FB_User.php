...
function New_Profile($conn){
	...
	if($f==true){
	    ...
	    //***************************Binding & Excecuting************************
		try{
            $sql="INSERT INTO customer (ID, NickName, FName, SName, Email, Pass, Birth, Place, Ship, Exp, Description, "."Creation, Verified, Img_name, fb_access_token) "    ."VALUES (0, ?, ?, ?, ?, '".$pwd."', '".$_POST['birth']."', ".$plc.	", ?, 0, ?, '".$today."', 1, ?, ?)";
